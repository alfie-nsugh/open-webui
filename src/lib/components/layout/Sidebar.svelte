		...
		>
			...
			>
				<div class="pb-1.5">
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<a
							id="sidebar-review-queue-button"
							class="grow flex items-center space-x-3 rounded-2xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition"
							href="/hitl"
							on:click={itemClickHandler}
							draggable="false"
						...
						>
							...
							<div class="flex items-center gap-2 self-center translate-y-[0.5px]">
								<div class="self-center text-sm font-primary">Review Queue</div>
								{#if hitlPendingCount > 0}
									<span class="flex items-center justify-center min-w-[18px] h-4 rounded-full bg-red-500 text-white text-[10px] font-bold px-1 leading-none">
										{hitlPendingCount > 9 ? '9+' : hitlPendingCount}
									</span>
								{/if}
							</div>
